...
Route::get("/warehouse_items", "WarehouseController@items")->name('warehouse.items');
Route::post("/warehouse", "WarehouseController@create")->name("warehouse.create");
Route::post("/warehouse/{id}", "WarehouseController@removeWarehouse")->name("warehouse.destroy");
Route::get("/warehouse/{id}/edit", "WarehouseController@edit")->name("warehouse.edit");
Route::put("/warehouse/{id}", "WarehouseController@update")->name("warehouse.update");
Route::get("/warehouse/view/{id}", "WarehouseController@viewData")->name("warehouse.view");

Route::get("/warehouse/transfer/page", "HelperController@transfer_page")->name("warehouse.transfer.page");
Route::get("/warehouse/transfer", "HelperController@transfer_index")->name("warehouse.transfer.index");
Route::post('/warehouse/transfer/get', 'HelperController@transfer_warehouse')->name('warehouse.transfer');
Route::get('/warehouse/transfer/{id}', 'HelperController@transfer_view')->name('warehouse.transfer.view');

// For warehouse api
Route::get("/warehouse/{id}/products", "WarehouseController@ProductsJson")->name('warehouse.products.json');
Route::get("/warehouse/{id}/rawitems", "WarehouseController@RawItemsJson")->name('warehouse.rawitems.json');


// Vendor Routes
Route::get('/vendor', 'VendorController@index')->name('vendor.index');
Route::post("/vendor", "VendorController@create")->name("vendor.create");
Route::post("/vendor/{id}", "VendorController@delete")->name("vendor.destroy");
Route::get("/vendor/{id}/edit", "VendorController@edit")->name("vendor.edit");
Route::post("/vendor/{id}/edit", "VendorController@update")->name('vendor.update');

Route::get('/purchase', 'PurchaseController@index')->name('purchase.index');
Route::get('/purchase/create', 'PurchaseController@gotoPurchaseCreate')->name('purchase.create.get');
Route::post("/purchase/create", "PurchaseController@create")->name("purchase.create");
Route::post("/purchase/{id}", "PurchaseController@delete")->name("purchase.destroy");
...
Route::put("/puchase/edit/{id}", "PurchaseController@update")->name("purchase.update");

Route::get('/raw-items', 'RawItemController@index')->name('rawitem.index');
Route::post("/raw-items", "RawItemController@create")->name("rawitem.create");
Route::post("/raw-items/{id}", "RawItemController@destroy")->name("rawitem.destroy");

// Units Routes
Route::get("/units", "UnitController@index")->name("unit.index");
Route::post("/units", "UnitController@create")->name("unit.create");
Route::get("/units/{id}/edit", "UnitController@edit")->name("unit.edit");
Route::put("/units/{id}", "UnitController@update")->name("unit.update");
Route::delete("/units/{id}", "UnitController@delete")->name("unit.delete");

Route::get("/itemsinfo", "ItemInfoController@index")->name("item.index");
Route::post("/itemsinfo", "ItemInfoController@create")->name("item.create");
Route::get("/itemsinfo/{id}", "ItemInfoController@edit")->name("item.edit");
Route::put("/itemsinfo/{id}", "ItemInfoController@update")->name("item.update");

Route::get("/department", "DepartmentController@index")->name("department.index");
Route::post("/department", "DepartmentController@create")->name("department.create");
Route::delete("/department/{id}", "DepartmentController@deleteDepartment")->name("department.delete");
...
Route::get("/sales/create", "SalesController@createPage")->name("sales.createPage");
Route::post("/sales", "SalesController@create")->name("sales.create");
Route::delete("/sales/{id}", "SalesController@delete")->name("sales.delete");
Route::get("/sales/{id}", "SalesController@view")->name("sales.view");

// Products Response API
Route::get("/response/products/{id}", "SalesController@fetchSingleProduct")->name("response.product");
//handle seacrh
Route::get('/search_raw_item', 'ExcelController@search')->name('rawitem.search');
Route::get('/search_product', 'ProductController@search')->name('product.search');


// handling excel sheets
Route::post('/rawitem-excelsheet', 'ExcelController@addExcel')->name('rawitem.excelsheet');
...
use App\Http\Controllers\ManufacturePlanController;

Route::prefix('admin')->name('admin.')->group(function () {
    Route::delete('/category_item/{id}', [CategoryItemController::class, 'destroy'])->name('category_item.destroy');
    Route::get('/category_item/create', [CategoryItemController::class, 'create'])->name('category_item.create');
    Route::post('/category_item', [CategoryItemController::class, 'store'])->name('category_item.store');
    Route::get('/category_item', [CategoryItemController::class, 'index'])->name('category_item.index');
    Route::get('/category_item/{category_item}', [CategoryItemController::class, 'edit'])->name('category_item.edit');
    Route::put('/category_item/{category_item}', [CategoryItemController::class, 'update'])->name('category_item.update');


    Route::get('/manufacture_plan', [ManufacturePlanController::class, 'index'])->name('manufacture_plan.index');
    Route::get('/manufacture_plan/create', [ManufacturePlanController::class, 'create'])->name('manufacture_plan.create');
    Route::post('/manufacture_plan', [ManufacturePlanController::class, 'store'])->name('manufacture_plan.store');
    Route::get('/manufacture_plan/{product}', [ManufacturePlanController::class, 'show'])->name('manufacture_plan.show');
    Route::get('/full_plan/{product}', [ManufacturePlanController::class, 'full_plan'])->name('full_plan.show');
    Route::get('/manufacture_plan/{id}/download-pdf', [ManufacturePlanController::class, 'downloadPdf'])->name('download.pdf');
    Route::post('/manufacture_plan/{id}/saveRemarks', [ManufacturePlanController::class, 'saveRemarks'])->name('manufacture_plan.saveRemarks');



    Route::get('/manufacture_plan/{manufacture_plan}/edit', [ManufacturePlanController::class, 'edit'])->name('manufacture_plan.edit');
    Route::put('/manufacture_plan/{manufacture_plan}', [ManufacturePlanController::class, 'update'])->name('manufacture_plan.update');
    Route::delete('/manufacture_plan/{manufacture_plan}', [ManufacturePlanController::class, 'destroy'])->name('manufacture_plan.destroy');
    Route::get('/fetch-product-details', [ManufacturePlanController::class, 'fetchProductDetails'])->name('fetch.product.details');

    Route::post('rawItem/get_warehouse', [ManufacturePlanController::class, 'getWarehouse'])->name('rawItem.get_warehouse');
    Route::post('rawItem/get_unit', [ManufacturePlanController::class, 'getUnit'])->name('rawItem.get_unit');
    Route::get('/cutting/{cutting}/edit', [CuttingController::class, 'edit'])->name('cutting.edit');
    Route::get('/printing/{printing}/edit', [PrintingController::class, 'edit'])->name('printing.edit');
    Route::get('/stiching/{stiching}/edit', [StitchingController::class, 'edit'])->name('stiching.edit');
    Route::get('/final/{final}/edit', [FinalController::class, 'edit'])->name('final.edit');
    Route::post('cutting/get_warehouse', [CuttingController::class, 'getWarehouse'])->name('cutting.get_warehouse');
    Route::post('/cutting/get_unit', [CuttingController::class, 'getUnit'])->name('cutting.get_unit');
    Route::get('/cutting', [CuttingController::class, 'index'])->name('cutting.index');
    Route::get('/cutting/{cutting}', [CuttingController::class, 'show'])->name('cutting.show');
    Route::delete('/cutting/{cutting}', [CuttingController::class, 'destroy'])->name('cutting.destroy');
    Route::put('cutting/{cutting}', [CuttingController::class, 'update'])->name('cutting.update');
    Route::post('/cutting/output_update', [CuttingController::class, 'outputUpdate'])->name('cutting.output_update');
    Route::put('printing/{printing}', [PrintingController::class, 'update'])->name('printing.update');
    Route::post('printing/get_warehouse', [PrintingController::class, 'getWarehouse'])->name('printing.get_warehouse');
    Route::post('/printing/get_unit', [PrintingController::class, 'getUnit'])->name('printing.get_unit');
    Route::get('/printing/{printing}', [PrintingController::class, 'show'])->name('printing.show');
    Route::delete('/printing/{printing}', [PrintingController::class, 'destroy'])->name('printing.destroy');
    Route::post('/printing/output_update', [PrintingController::class, 'outputUpdate'])->name('printing.output_update');

    Route::put('stiching/{stiching}', [StitchingController::class, 'update'])->name('stiching.update');
    Route::post('stiching/get_warehouse', [StitchingController::class, 'getWarehouse'])->name('stiching.get_warehouse');
    Route::post('/stiching/get_unit', [StitchingController::class, 'getUnit'])->name('stiching.get_unit');
    Route::get('/stiching/{stiching}', [StitchingController::class, 'show'])->name('stiching.show');
    Route::delete('/stiching/{stiching}', [StitchingController::class, 'destroy'])->name('stiching.destroy');
    Route::post('/stiching/output_update', [StitchingController::class, 'outputUpdate'])->name('stiching.output_update');
    Route::post('/stiching/warehouse_update', [StitchingController::class, 'warehouseUpdate'])->name('stiching.warehouse_update');


    Route::put('final/{final}', [FinalController::class, 'update'])->name('final.update');
    Route::post('final/get_warehouse', [FinalController::class, 'getWarehouse'])->name('final.get_warehouse');
    Route::post('/final/get_unit', [FinalController::class, 'getUnit'])->name('final.get_unit');
    Route::get('/final/{final}', [FinalController::class, 'show'])->name('final.show');
    Route::delete('/final/{final}', [FinalController::class, 'destroy'])->name('final.destroy');
    Route::post('/final/output_update', [FinalController::class, 'outputUpdate'])->name('final.output_update');
    ...
    Route::get('/stiching', [StitchingController::class, 'index'])->name('stiching.index');
    Route::get('/final', [FinalController::class, 'index'])->name('final.index');
    Route::post('/cutting/start', [CuttingController::class, 'start'])->name('cutting.start');
    Route::post('/printing/start', [PrintingController::class, 'start'])->name('printing.start');
    Route::post('/stiching/start', [StitchingController::class, 'start'])->name('stiching.start');
    Route::post('/final/start', [FinalController::class, 'start'])->name('final.start');
});
